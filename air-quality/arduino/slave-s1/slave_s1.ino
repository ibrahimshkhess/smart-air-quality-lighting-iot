...
void loop() {
  ...
  // Increment application sequence number
  seq++;

  // Timestamp close to transmission time
  unsigned long timestamp = millis();

  // Build ZigBee payload
  char payload[96];
  ...
  // Keep approximately 30 seconds between cycle starts
